...
public class HelloArActivity extends AppCompatActivity implements SampleRender.Renderer {
  ...
  HandlerThread thread = new HandlerThread("kk");
  Handler worker = null;
  ...
  private Runnable update = new Runnable() {
    ...
    public void run() {
      ...
      try {
        ...
        com.google.ar.core.Pose currentPose = frame.getCamera().getDisplayOrientedPose();
        // Now `currentPose` contains the latest device position and orientation
        float tx = currentPose.tx();  // X translation
        float ty = currentPose.ty();  // Y translation
        float tz = currentPose.tz();  // Z translation
        Log.d("xixia", "tx: " + tx + ", ty: " + ty + ", tz: " + tz);
  ...
  public void onDrawFrame(SampleRender render) {
    ...
    com.google.ar.core.Pose currentPose = camera.getDisplayOrientedPose();
